 ...
 * @author Tahir Yasin
 *
 * This class is based on WordPress API for creating bbcode like tags or what WordPress calls
...
class ShortCode extends CApplicationComponent{
...
function __construct(){
    $this->add_filter('the_content', 'do_shortcode', 11);
}
...
private function _wp_filter_build_unique_id($tag, $function, $priority) {
	global $wp_filter;
